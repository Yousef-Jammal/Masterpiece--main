...
function initLanguage() {
    // Set new language
    (language === null) ? setLanguage(default_lang) : setLanguage(language);  // للاحتراز
...
function setLanguage(lang) {
    if (document.getElementById("header-lang-img")) {
        if (lang == "en") {
            document.getElementById("header-lang-img").src = "/images/flags/20/us.svg";
        } else if (lang == "sp") {
            document.getElementById("header-lang-img").src = "/images/flags/20/es.svg";
        } else if (lang == "gr") {
            document.getElementById("header-lang-img").src = "/images/flags/20/de.svg";
        } else if (lang == "it") {
            document.getElementById("header-lang-img").src = "/images/flags/20/it.svg";
        } else if (lang == "ru") {
            document.getElementById("header-lang-img").src = "/images/flags/20/ru.svg";
        } else if (lang == "ch") {
            document.getElementById("header-lang-img").src = "/images/flags/20/china.svg";
        } else if (lang == "fr") {
            document.getElementById("header-lang-img").src = "/images/flags/20/fr.svg";
        } else if (lang == "ar") {
            document.getElementById("header-lang-img").src = "/images/flags/20/ae.svg";
        } else if (lang == "jp") {
            document.getElementById("header-lang-img").src = "/images/flags/20/jp.svg";
        } else if (lang == "ar") {
            document.getElementById("header-lang-img").src = "/images/flags/20/ae.svg";
        }
...
function hideShowLayoutOptions(dataLayout) {   // hi i am you i edited this lock line 1
