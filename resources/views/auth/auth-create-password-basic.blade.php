...
<head>
    ...
    <meta charset="utf-8">
    <title>Two Steps | Tailwick - Admin & Dashboard Template</title>
            ...
            <div class="!px-10 !py-12 card-body">
                ...
                <form autocomplete="off" action="index.html">
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">Hold on, I've got my password... <a href="auth-login-basic.html" class="underline fw-medium text-custom-500"> Click here </a> </p>
                    </div>
                </form>
            </div>
        </div>
