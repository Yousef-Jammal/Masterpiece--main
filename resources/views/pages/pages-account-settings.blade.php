                    ...
                    <div class="block tab-pane" id="personalTabs">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('user-update-info') }}" >
                                    @csrf
                                    @method('PUT')
                                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                                        ...
                                        <div class="hiddden xl:col-span-6 hidden">
                                        ...
                                        <div style="display: none" class="hiddden xl:col-span-6">
                                        ...
                                        <div style="display: none" class=" xl:col-span-12">
                                        ...
                                        <div style="display: none" class="hiddden xl:col-span-4">
                                        ...
                                        <div style="display: none" class="hiddden xl:col-span-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="flex gap-3 mb-5">
                                        <div class="grow">
                                            <img src="{{ asset('images/meta.png') }}" alt="" class="h-8">
                                        </div>
                                        <div class="shrink-0">
