            ...
            <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                ...
                <div class="tab-content">
                    ...
                    <div class="hidden tab-pane" id="integrationTabs">
                        {{-- <h6 class="mb-4 text-15">List View</h6> --}}
                                ...
                                <div class="sticky card print:hidden top-[calc(theme('spacing.header')_+_theme('spacing.5'))]">
                                    <div class="card-body">
                                        ...
                                        <div class="hidden flex items-center gap-2">
                                            ...
                                            <button type="button" class="flex items-center justify-center size-[37.5px] p-0 text-sky-500 btn bg-sky-100 hover:text-white hover:bg-sky-600 focus:text-white focus:bg-sky-600 focus:ring focus:ring-sky-100 active:text-white active:bg-sky-600 active:ring active:ring-sky-100 dark:bg-sky-500/20 dark:text-sky-400 dark:hover:bg-sky-500 dark:hover:text-white dark:focus:bg-sky-500 dark:focus:text-white dark:active:bg-sky-500 dark:active:text-white dark:ring-sky-400/20"><i data-lucide="sliders-horizontal" class="size-4"></i></button>
                                        </div>
                                    </div>
                                    <div data-simplebar class="h-[calc(100vh_-_theme('height.14')_-_theme('spacing.5')_-_theme('height.header')_*_3.5)]">
                                        @foreach($orders as $order)
                                        <div style="margin: 1rem 1px">
                                            <a href="#!" data-invoice-id="{{ $order->id }}" class="invoiceList block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 dark:border-zink-500 dark:hover:bg-zink-600 dark:[&.active]:bg-zink-600 active">
                                                <div class="float-right">
                                                {{-- <span class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-yellow-100 border-transparent text-yellow-500 dark:bg-yellow-500/20 dark:border-transparent">Unpaid</span> --}}
                                                </div>
                                                {{-- <h6>#TW15090251</h6> --}}
                                                <div class="flex">
                                                    <div class="grow">
                                                        <h6 class="mt-3 mb-1 text-16">{{ $order->user->name }}</h6>
                                                        <p class="text-slate-500 dark:text-zink-200">${{ $order->price }}</p>
                                                    </div>
                                                    <p class="self-end mb-0 text-slate-500 dark:text-zink-200 shrink-0">
                                                        ...
                                                        <span class="align-middle">{{ $order->created_at->format('d M, Y') }}</span>
                                                    </p>
                                                </div>
                                            </a>
                                        </div>
