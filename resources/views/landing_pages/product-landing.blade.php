...
@section('content')
    ...
    <nav class="hidden fixed inset-x-0 top-0 z-50 flex items-center justify-center h-20 py-3 [&.is-sticky]:bg-white dark:[&.is-sticky]:bg-zinc-900 border-b border-slate-200 dark:border-zinc-800 [&.is-sticky]:shadow-lg [&.is-sticky]:shadow-slate-200/25 dark:[&.is-sticky]:shadow-zinc-700/30 navbar" id="navbar">
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto flex items-center self-center w-full">
            ...
            <div class="flex gap-3 ms-auto">
                ...
                {{-- <a type="button" class="cursor-pointer text-slate-500 dark:text-zinc-300 hover:text-custom-500 dark:hover:text-custom-500 border-0 btn bg-gradient-to-r w-[36.39px] p-0 flex items-center justify-center"><i data-lucide="shopping-bag" class="inline-block size-4"></i></a>
                <a href="{{ route('logout') }}" type="button" class="cursor-pointer text-white border-0 btn bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500"><span class="align-middle">Logout</span> <i data-lucide="log-in" class="inline-block size-4 ltr:ml-1 rtl:mr-1"></i></a> --}}
            {{-- </div> --}}
            ...
            <div class="grid items-center grid-cols-12 gap-5 2xl:grid-cols-12">
                <div class="col-span-12 xl:col-span-5 2xl:col-span-5">
                    ...
                    <div class="flex items-center gap-2" data-aos="fade-right" data-aos-delay="800">
                        <a href="{{ route('show_products') }}" class="px-8 py-3 text-white border-0 text-15 btn bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500">Shop Now <i data-lucide="shopping-cart" class="inline-block align-middle size-4 rtl:mr-1 ltr:ml-1"></i></a>
                    </div>
                </div>
                <div class="col-span-12 xl:col-span-7 2xl:col-start-8 2xl:col-span-6">
                    <div class="relative mt-10 xl:mt-0">
                        ...
                        <div class="relative" data-aos="zoom-in" data-aos-delay="500">
                            <button style="display: none" data-tooltip="default" data-tooltip-content="$199.99" class="absolute items-center justify-center hidden bg-white rounded-full size-8 xl:flex bottom-20 text-slate-800 left-20 "><i data-lucide="plus"></i></button>
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-5 mt-12 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="p-5 rounded-md bg-gradient-to-b from-slate-100 to-white dark:from-zinc-800 dark:to-zinc-900" data-aos="fade-up" data-aos-easing="linear">
                    <img src="{{ asset('images/product/' . $product->images->first()->name . '') }}" alt="" class="mx-auto h-52">
                    <div class="mt-3">
                        ...
                        <div class="flex items-center gap-3 mt-3">
                            ...
                            <div class="shrink-0">
                                <a
                                href="{{ route('product_show', $product->code) }}"
                                {{-- id="add_to_cart"
                                type="button" --}}
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="grid items-center grid-cols-1 gap-6 mt-20 lg:grid-cols-12">
                <div class="lg:col-span-5">
                    ...
                    <a href="{{ route("show_products") }}" class="text-custom-500 text-16" data-aos="fade-right" data-aos-delay="600">Shopping Now <i data-lucide="move-right" class="inline-block align-middle size-4 ltr:ml-1 rtl:mr-1 rtl:rotate-180"></i></a>
                </div><!--end col-->
            ...
            <div class="grid items-center grid-cols-1 gap-6 mt-20 lg:grid-cols-12">
                <div class="relative lg:col-span-5">
                    <div class="relative before:absolute before:h-full before:w-full before:border-[15px] before:border-double before:border-green-500/10 before:-top-16 lg:before:-right-16" data-aos="zoom-out-up">
                        ...
                        <img src="{{ asset('images/landing/about_test.webp') }}" alt="" class="relative inline-block rounded-md" data-aos="zoom-out-up" data-aos-delay="500">
                    </div>
                </div><!--end col-->
                <div class=" ml-auto lg:col-span-5 lg:col-start-8">
                    <p style="font-size: 3rem" class="mb-2 text-purple-500 text-15" data-aos="fade-left" data-aos-delay="300">About Us</p>
                    <h1 class="text-3xl mb-3 leading-normal capitalize" data-aos="fade-left" data-aos-delay="400">We Provide high Quality shoes</h1>
    ...
    <section class="relative py-24 xl:py-32 hidden" id="feedback">
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
    ...
    <section class="relative py-20 border-t border-slate-200 dark:border-zinc-800 hidden">
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
    ...
    <footer class="relative pt-20 pb-12 border-t border-slate-200 dark:border-zinc-800">
        ...
        <div class="pt-10 mt-16 text-center border-t text-slate-500 dark:text-zinc-400 dark:border-zinc-800 text-16">
            <p>
                <script>document.write(new Date().getFullYear())</script> © Tailwick. Design & Develop by
