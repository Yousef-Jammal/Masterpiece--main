                        ...
                        <div class="card" id="usersTable">
                            ...
                            <div class="card-body ">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="shrink-0">
                                        <button data-modal-target="addDiscountCodeModal" type="button" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i data-lucide="plus" class="inline-block size-4"></i> <span class="align-middle">Add User</span></button>
                                    </div>
                                </div>
                            </div>

                            <div class="hidden !py-3.5 card-body border-y border-dashed border-slate-200 dark:border-zink-500">
                                <form action="#!">
                                    ...
                                    <table class="w-full border-separate table-custom border-spacing-y-1 whitespace-nowrap">
                                        <thead class="text-left">
                                            <tr class="relative rounded-md bg-slate-100 dark:bg-zink-600 after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600">
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Code</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Discount Amount</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Discount Percentage</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Max Uses</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Used Count</th>
                                                {{-- <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Minimum Order Amount</th> --}}
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Start Date</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">End Date</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Status</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Validate</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Joining Date</th>
                                            ...
                                            <tr class="relative rounded-md after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600">
                                                ...
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                    <div class="flex items-center gap-2">
                                                        <div class="grow">
                                                            <h6 class="mb-1">{{ $discountCode->code }}</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $discountCode->discount_amount ? $discountCode->discount_amount . '$ JD' : '-----------' }}</td>
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $discountCode->discount_percentage ? $discountCode->discount_percentage . '%' : '-----------' }}</td>
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $discountCode->max_uses ? $discountCode->max_uses : '-----------' }}</td>
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $discountCode->used_count ? $discountCode->used_count : 0 }}</td>
                                                {{-- <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $discountCode->minimum_order_amount ? $discountCode->minimum_order_amount : '-----------' }}</td> --}}
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $discountCode->start_date ? $discountCode->start_date : '-----------' }}</td>
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">{{ $discountCode->end_date ? $discountCode->end_date : '-----------' }}</td>
                                                ...
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                    @if(  $discountCode->is_active && (!$discountCode->start_date || $discountCode->start_date <= now()) && (!$discountCode->end_date || $discountCode->end_date >= now()))
                                                    <span class="px-2.5 py-0.5 text-xs font-medium rounded border bg-green-100 border-transparent text-green-500 dark:bg-green-500/20 dark:border-transparent inline-flex items-center status">
                                                        <i data-lucide="check-circle" class="size-3 mr-1.5"></i>
                                                        Valid
                                                    </span>
                                                ...
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 joining-date">{{ $discountCode->created_at ? $discountCode->created_at : '-----------' }}</td>
                                                ...
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                    <div class="relative dropdown">
                                                        ...
                                                        <ul class="absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600" aria-labelledby="usersAction1">
                                                            <li>
                                                                <a data-modal-target="editDiscountCodeModal" data-discountCode-info='{{ json_encode($discountCode) }}'  class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200" href="#!"><i data-lucide="file-edit" class="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Edit</span></a>
                                                            </li>
                                                            <li>
                                                                <a data-modal-target="deleteModal" data-this-id="{{ $discountCode->id }}" class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200" href="#!"><i data-lucide="trash-2" class="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Delete</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
...
<div id="addDiscountCodeModal" modal-center class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="flex items-center justify-between p-4 border-b dark:border-zink-300/20">
            <h5 class="text-16">Add discountCode</h5>
            <button  data-modal-close="addDiscountCodeModal" class="transition-all duration-200 ease-linear text-slate-400 hover:text-red-500"><i data-lucide="x" class="size-5"></i></button>
        </div>
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form action="{{ route('discount_codes.store') }}" method="POST" class="customForm" >
                @csrf

                <!-- Discount Code Field -->
                <div class="mb-3">
                    <label for="code" class="inline-block mb-2 text-base font-medium">Discount Code</label>
                    <input type="text" id="code" name="code" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" >
                    @if ($errors->has('code'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('code') }}</div>
                    @endif
                </div>

                <!-- Discount Amount Field -->
                <div class="mb-3">
                    <label for="discount_amount" class="inline-block mb-2 text-base font-medium">Discount Amount</label>
                    <input type="number" id="discount_amount" name="discount_amount" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" >
                    @if ($errors->has('discount_amount'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('discount_amount') }}</div>
                    @endif
                </div>

                <!-- Discount Percentage Field -->
                <div class="mb-3">
                    <label for="discount_percentage" class="inline-block mb-2 text-base font-medium">Discount Percentage</label>
                    <input type="number" id="discount_percentage" name="discount_percentage" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" >
                    @if ($errors->has('discount_percentage'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('discount_percentage') }}</div>
                    @endif
                </div>

                <!-- Max Uses Field -->
                <div class="mb-3">
                    <label for="max_uses" class="inline-block mb-2 text-base font-medium">Max Uses</label>
                    <input type="number" id="max_uses" name="max_uses" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" >
                    @if ($errors->has('max_uses'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('max_uses') }}</div>
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" id="start_date" name="start_date" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" >
                    @if ($errors->has('start_date'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('start_date') }}</div>
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" id="end_date" name="end_date" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" >
                    @if ($errors->has('end_date'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('end_date') }}</div>
                    @endif
                </div>

                <!-- Status Field (Active or Not Active) -->
                <div class="mb-3">
                    <label for="is_active" class="inline-block mb-2 text-base font-medium">Status</label>
                    <select id="is_active" name="is_active" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500">
                        <option value="1" selected>Active</option>
                        <option value="0">Not Active</option>
                    </select>
                    @if ($errors->has('is_active'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('is_active') }}</div>
                    @endif
                </div>


                <div class="flex justify-end gap-2 mt-4">
                    <button type="reset" data-modal-close="addDiscountCodeModal" class="text-red-500 transition-all duration-200 ease-linear bg-white border-white btn hover:text-red-600 focus:text-red-600 active:text-red-600 dark:bg-zink-500 dark:border-zink-500">Cancel</button>
                    <button type="submit" class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Add discountCode</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="editDiscountCodeModal" modal-center class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="flex items-center justify-between p-4 border-b dark:border-zink-300/20">
            <h5 class="text-16">Edit discountCode</h5>
            <button data-modal-close="editDiscountCodeModal" class="transition-all duration-200 ease-linear text-slate-400 hover:text-red-500"><i data-lucide="x" class="size-5"></i></button>
        </div>
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form action="{{ route('discount_codes.update', 1) }}" method="POST" class="customForm1">
                @csrf
                @method('PUT')
                <input type="hidden" name="this_id">
                ...
                <!--  Used Cound Field -->
                <div class="mb-3">
                    <label for="used_count" class="inline-block mb-2 text-base font-medium">Used Count</label>
                    <input type="number" id="used_count" name="used_count" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" >
                    @if ($errors->has('used_count'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('used_count') }}</div>
                    @endif
                </div>
                ...
                <div class="flex justify-end gap-2 mt-4">
                    <button type="reset" data-modal-close="editDiscountCodeModal" class="text-red-500 transition-all duration-200 ease-linear bg-white border-white btn hover:text-red-600 focus:text-red-600 active:text-red-600 dark:bg-zink-500 dark:border-zink-500">Cancel</button>
    ...
    <div class="w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
            ...
            <div class="mt-5 text-center">
                <form action="{{ route('discount_codes.destroy', 1) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <input type="hidden" name="this_id">
...
<!-- User list init js -->
{{-- <script src="{{ asset('js/pages/validations/updateUser.js') }}"></script> --}}
