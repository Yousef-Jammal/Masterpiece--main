                                    ...
                                    <table class="w-full border-separate table-custom border-spacing-y-1 whitespace-nowrap">
                                        <thead class="text-left">
                                            <tr class="relative rounded-md bg-slate-100 dark:bg-zink-600 after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600">
                                                ...
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">User ID</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Name</th>
                                                ...
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort" >Email</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort">Phone Number</th>
                                        ...
                                        <tbody class="list">
                                            ...
                                            <tr class="relative rounded-md after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600">
                                                ...
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 phone-number">{{ $user->phoneNumber }}</td>
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 joining-date">{{ $user->created_at }}</td>
                                                ...
                                                <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                    <div class="relative dropdown">
                                                        ...
                                                        <ul class="absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600" aria-labelledby="usersAction1">
                                                            <li>
                                                                <a data-modal-target="editUserModal" data-user-info='{{ json_encode($user) }}'  class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200" href="#!"><i data-lucide="file-edit" class="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Edit</span></a>
                                                            </li>
                                                            <li>
                                                                <a data-modal-target="deleteModal" data-this-id="{{ $user->id }}" class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200" href="#!"><i data-lucide="trash-2" class="inline-block size-3 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Delete</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
...
<div id="addUserModal" modal-center class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form action="{{ route('amdin_users_add') }}" method="POST" class="customForm" >
                @csrf

                <!-- Name Field -->
                <div class="mb-3">
                    <label for="name" class="inline-block mb-2 text-base font-medium">Name</label>
                    <input autocomplete="new-name" type="text" id="name" name="name" placeholder="Enter name" value="{{ old('name') }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 name">
                    <div class="text-red-500 text-sm mt-1 hidden name_error">You should enter name</div>
                    @if ($errors->has('name'))
                ...
                <div class="mb-3">
                    ...
                    <input type="email" id="emailInput" name="email" placeholder="Enter email" value="{{ old('email') }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 emailInput">
                    <div class="text-red-500 text-sm mt-1 hidden email_error">Valid Email is required</div>
                    @if ($errors->has('email'))
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="phone" name="phone" placeholder="+962 7..." value="{{ old('phone') }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 phone">
                    <div class="text-red-500 text-sm mt-1 hidden phone_error">Phone Number is field</div>
                    @if ($errors->has('phone'))
                ...
                <div class="mb-3">
                    ...
                    <input type="password" id="passwordInput" name="password" placeholder="Enter password" value="{{ old('password') }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 passwordInput">
                    <div class="text-red-500 text-sm mt-1 hidden password_error">Password is required</div>
...
<div id="editUserModal" modal-center class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form action="{{ route('updateUserInfo') }}" method="POST" class="customForm1">
                @csrf
                @method('PUT')
                <input type="hidden" name="this_id">
                <!-- Arabic Name Field -->
                <div class="mb-3">
                    <label for="name" class="inline-block mb-2 text-base font-medium">Arabic Name</label>
                    <input autocomplete="new-name" type="text" id="name" name="name" placeholder="Enter name" value="{{ old('name') }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 name_ar">
                    <div class="text-red-500 text-sm mt-1 hidden name_ar_error">You should enter Arabic name</div>
                    @if ($errors->has('name_ar'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('name_ar') }}</div>
                    @endif
                </div>
                ...
                <div class="mb-3">
                    <label for="phone" class="inline-block mb-2 text-base font-medium">Phone Number</label>
                    <input type="text" id="phone" name="phone" placeholder="+962 7..." value="{{ old('phoneNumber') }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 phone">
                    <div class="text-red-500 text-sm mt-1 hidden phone_error">Phone Number is field</div>
                    @if ($errors->has('phoneNumber'))
                        <div class="text-red-500 text-sm mt-1">{{ $errors->first('phoneNumber') }}</div>
                    @endif
                </div>
